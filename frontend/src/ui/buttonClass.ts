...
// "button" kept for container-specific CSS hooks (e.g. .landing-cta-row .button, dark mode .button-secondary)
const BASE =
  "button inline-flex cursor-pointer items-center justify-center gap-[0.4rem] whitespace-nowrap rounded-lg px-4 py-[0.6rem] text-[0.875rem] font-semibold no-underline transition-[background,transform,box-shadow,border-color] hover:not-disabled:-translate-y-px disabled:cursor-not-allowed disabled:opacity-55";
...
const VARIANTS: Record<ButtonVariant, string> = {
  ...
  danger:
    "button-danger border border-[#c0392b] bg-[#c0392b] text-white hover:not-disabled:border-[#a53124] hover:not-disabled:bg-[#a53124]",
};
